defmodule Election do
  ...
  #sort_candidates_by_votes_desc(candidates)
  ...
  defp maybe_inc_vote(candidate, true) do
    Map.update!(candidate, :votes, fn a -> a + 1 end)
    # &(&1 + 1)
  end
  ...
  defp candidate_to_strings(candidates) do
    candidates
  ...
  defp prepend_candidate_header(candidates) do
    [
      "ID\tVotes\tName\n",
      "------------------------------\n"
      | candidates
